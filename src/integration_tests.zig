...
// TODO: Re-enable once movie rendering pipeline is fixed (non-black pixel assertion fails —
// all 12 scenes parse and render but the framebuffer stays black, likely a palette or
// BFOR composition issue in movie_renderer).
//
